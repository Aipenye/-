<template>
    <div>
        <div class="toolbar">
            ...
            <el-button type="success" size="small" icon="el-icon-plus" @click="add" class="round-btn" style="margin-left:auto">新增管理员</el-button>
        </div>
        ...
        <el-table :data="tableData"
            ...
            <el-table-column prop="roleId" label="角色" width="120">
                <template slot-scope="scope">
                    <el-tag :type="scope.row.roleId === 0 ? 'danger' : 'primary'" disable-transitions>
        ...
        <el-dialog title="管理员信息维护" :visible.sync="centerDialogVisible" width="30%" center>
            <el-form ref="form" :rules="rules" :model="form" label-width="80px">
                ...
                <el-form-item label="密码" prop="password">
                    <el-col :span="20"><el-input v-model="form.password"></el-input></el-col>
                </el-form-item>
                <el-form-item label="年龄" prop="age">
                    <el-col :span="20"><el-input v-model="form.age"></el-input></el-col>
                </el-form-item>
                ...
                <el-form-item label="电话" prop="phone">
                    <el-col :span="20"><el-input v-model="form.phone"></el-input></el-col>
                </el-form-item>
            </el-form>
