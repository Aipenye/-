...
class BedSchedulingResourceTest {
    ...
    //test not applicable after switching to first fit approach
    /*@Test
    void solveDemoDataUntilFeasible() {
        ...
        assertThat(solution.getBoxes().stream().allMatch(bedDesignation -> bedDesignation.getAirCube() != null)).isTrue();
