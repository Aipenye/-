...
CREATE TABLE `goods`  (
  ...
  `storage` int(0) NULL DEFAULT NULL COMMENT '仓库',
  `goodsType` int(0) NULL DEFAULT NULL COMMENT '分类',
...
-- goods 表：放宽 storage / goodsType 非空约束，允许只录入物品名+尺寸
ALTER TABLE `goods` MODIFY COLUMN `storage`   int(0) NULL DEFAULT NULL COMMENT '仓库';
ALTER TABLE `goods` MODIFY COLUMN `goodsType` int(0) NULL DEFAULT NULL COMMENT '分类';
